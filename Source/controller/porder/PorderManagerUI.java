...
public class PorderManagerUI extends JFrame {
    ...
    public PorderManagerUI() {
        ...
        rose = new JTextField();
        rose.setBounds(62, 363, 72, 21);
        rose.setColumns(10);
        contentPane.add(rose);

        lblNewLabel_3 = new JLabel("鼓");
        lblNewLabel_3.setBounds(21, 367, 46, 15);
        lblNewLabel_3.setHorizontalAlignment(SwingConstants.CENTER);
        contentPane.add(lblNewLabel_3);

        lblNewLabel_4 = new JLabel("吉他");
        lblNewLabel_4.setBounds(13, 309, 46, 15);
        ...
        lblNewLabel_3_1.setBounds(144, 306, 57, 15);
        contentPane.add(lblNewLabel_3_1);

        JDateChooser dateChooser = new JDateChooser();
        dateChooser.setDateFormatString("y-M-d");
        dateChooser.setBounds(204, 306, 88, 26);
        ...
        btnNewButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
            	...
            	List<Porder> orders = porderserviceimpl.findOrdersByName(customer.getName());
        ...
        btnNewButton_1.setBounds(216, 361, 85, 23);
        ...
        btnNewButton_2.setBounds(499, 281, 85, 23);
        ...
        panel = new JPanel();
        panel.setBounds(297, 213, 287, 29);
        ...
        lblNewLabel_3_2.setBounds(21, 275, 46, 15);
        contentPane.add(lblNewLabel_3_2);

        recipient = new JTextField();
        recipient.setColumns(10);
        recipient.setBounds(62, 271, 230, 21);
